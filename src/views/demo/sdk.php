...
<div class="row container">
	<div class="col-md-12">
		...
		<p>
			...
			затем <a href="<?= URL::route('ff-bank-em-term') ?>">получить терминал</a> (и тогда все платежные операции
			будут связаны с вашим аккаунтом на нашем сайте). Либо установите шлюз на свой сервер (вам понадобится Laravel,
